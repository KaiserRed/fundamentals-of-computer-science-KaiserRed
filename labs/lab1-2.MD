...
### 2. **Цель работы** 
Освоение программного обеспечения UNIX

### 3. **Задание**
Ознакомиться с сервисными функциями. Работа с директориями. Создание, удаление файлов и директорий и перемещение по ним. 
...
Для достижения поставленной цели нужно использовать основные команды bash для работы с каталогами, текстовыми файлами, тектовыми редакторами и некоторыми утилитами
...
### 8. **Вывод:**
Была изучена работа с директориями UNIX, создание, изменения и перемещения файлой, использование **gnuplot**, работа с процессами. Были получены базовые навыки владения ОС UNIX.
